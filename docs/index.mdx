...
<span class="sinoui-switch">
  <span class="sinoui-switch-base">
    <span class="sinoui-switch-label">
      <input class="sinoui-switch-input" />
      <span class="sinoui-switch-thumb" />
    </span>
  </span>
  <span class="sinoui-switch-track" />
</span>
```
